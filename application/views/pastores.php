        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header card-header-bdn">
                <h4 class="card-title">Pastores <button class="btn btn-sm btn-secondary pull-right">Novo pastor</button> </h4>
              <p class="card-category">Pastores cadastrado para Bola de Neve Araucária</p>
            </div>
            <div class="card-body">
