        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header card-header-bdn">
                <h4 class="card-title">Escalas <button class="btn btn-sm btn-secondary pull-right">Criar escala</button></h4>
              <p class="card-category">Gestão das escalas dos responsáveis</p>
            </div>
            <div class="card-body">
