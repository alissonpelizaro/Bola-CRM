...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo base_url() ?>public/img/logo_black.png">
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
  <title>
    BDN Araucária - Ministério de Comunicação
  </title>
  ...
  <!-- CSS Files -->
  <link href="<?php echo base_url() ?>public/css/material-dashboard.css?v=2.1.1" rel="stylesheet" />
